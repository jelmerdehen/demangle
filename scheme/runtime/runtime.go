...
var prefixes = []struct {
	...
	{"__fortify_", "glibc", "glibc _FORTIFY_SOURCE helper"},
	{"__tls_get_addr", "gcc", "TLS get_address helper"},
	{"__dso_handle", "gcc", "DSO handle for destructors"},
	{"__stack_protector_", "gcc", "stack protector helper"},
	{"__synch_", "apple", "Apple libc synch helpers"},
	{"_NSConcrete", "apple", "Apple NSConcrete* helpers"},
