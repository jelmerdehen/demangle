...
Cumulative ZA..ZS = +384 production (56348 → 56732, 88.38% → 88.98%). Further parity gains gated on bound-generic-subs-indexing refactor + tryPath nested-tuple support.
