...
Cumulative ZA..ZU = +396 production (56348 → 56744, 88.38% → 89.00%). Further parity gains gated on bound-generic-subs-indexing refactor + tryPath nested-tuple/function-type-as-arg support.
