...
Cumulative ZA..ZW = +397 production (56348 → 56745, 88.38% → 89.00%). Further parity gains gated on bound-generic-subs-indexing refactor + tryPath nested-tuple/function-type-as-arg support + private-decl-name "related decl" render.
