...
|------|------|--------|--------------|
| fastpath-candidate-broadening | plans/fastpath-candidate-broadening.md | P1 pending — ObjC-host + literal-module-host candidate detection; ~+150-300P bounded, ~7 fires | 2026-05-26 |
